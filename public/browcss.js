...
if (navig_ie5) 
{
	document.write("<link rel='stylesheet' href='/GSAAutoAuctions/resources/css/styleIE.css' type='text/css' />");
}
...
else if (navig_ie7) 
{
  ...
  {
	document.write("<link rel='stylesheet' href='/GSAAutoAuctions/resources/css/styleIE8.css' type='text/css' />");
}
else
{
	document.write("<link rel='stylesheet' href='./GSA Fleet Vehicle Sales_files/style.css' type='text/css' />");
}